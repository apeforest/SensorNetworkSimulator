...
#define GVEXPOSURESENSORNETWORK2D_MAXINT				32767
#define GPSR_DONE										0
#define GPSR_FAIL										(GPSR_DONE+1)
#define GPSR_CONTINUE									(GPSR_FAIL+1)

// Lin's Definition for Event detection
#define EVENTPROBABILITY								0.5
#define P0												0.2
#define P1												0.7
#define N1												1
#define N2												3
#define UNITENERGYTRANSMIT								400	
#define UNITENERGYRECEIVE								50
#define UNITENERGYMONITOR								10
#define UNITENERGYPROCESS								40
#define UNITENERGYSEQUENTIAL							100
#define CENTRALIZED										(0)
#define DISTRIBUTED										(CENTRALIZED + 1)	
#define HYBRID											(DISTRIBUTED + 1)
#define SEQUENTIAL										(HYBRID + 1)
#define LHRFACTOR1										(P1*(1-P0)/(P0*(1-P1)))
#define LHRFACTOR2										(1-P1)/(1-P0)
#define LHR1											13.60
#define LHR0											0.07
#define SQUARE(x)										x*x
#define MAXNUMEVENT										50
...
{ // GVExposureSensorNetwork2D
  ...
  public:
	...
	double GetDistanceSquareSum(void);
}; // GVExposureSensorNetwork2D
