...
{ // OutputResults
  ...
  OutFile << NumSensors         << GVEXPOSURESENSORNETWORK2D_SPACE
          ...
          << AreaTotal          << GVEXPOSURESENSORNETWORK2D_SPACE
          << AreaUncovered      << GVEXPOSURESENSORNETWORK2D_SPACE
          << AreaCovered        << GVEXPOSURESENSORNETWORK2D_SPACE
...
/*
  ...
  any new area exists, and if new area exists, the algorithm is not done.
...
{ // MaxExposure_Run
  ...
  {
    case GVEXPOSURESENSORNETWORK2D_MODE_UPDATE:
      if (!MaxExposure_Update()) AlgorithmStage = GVEXPOSURESENSORNETWORK2D_MODE_CALCULATE;
    break;
