...
#define GVEXPOSURESENSORNETWORK2D_PROGRESSMESSAGE      0
...
#define GVEXPOSURESENSORNETWORK2D_MODE_NUM             (GVEXPOSURESENSORNETWORK2D_MODE_CALCULATE + 1)
...
{ // GVExposureSensorNetwork2D
  protected:
    ...
    double MaxLength;           // Maximum Length of Path
